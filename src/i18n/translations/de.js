export const de = {
  ...
  banner: {
    ...
    scrollDown: "Scrollen",
    title: "Junior Full-Stack Entwicklerin",
    based: "Wohnhaft in",
  ...
  about: {
    eyebrow: "Über mich",
    title: "Vom Gastgewerbe zum Full-Stack-Bildschirm.",
    paragraph1:
    ...
    openToLabel: "Offen für",
    openToValue: "Junior-Rollen · Freelance · Remote",
    toolsLabel: "Werkzeuge, mit denen ich arbeite",
  },
  contact: {
    eyebrow: "Kontakt",
    title: "Kontakt aufnehmen",
    line1: "Lass uns etwas",
    line2: "bauen.",
    sub: "Offen für Junior-Positionen, Freelance-Aufträge und Kooperationen in der Schweiz und remote.",
    sendEmail: "E-Mail senden",
    pageLabel: "Kontakt",
    pageDescription:
      "Ob du ein Projekt im Sinn hast, eine Frage stellen möchtest oder einfach Hallo sagen willst — ich freue mich von dir zu hören.",
    cardTitle: "Aktuell offen",
    cardDescription:
    ...
    whatsappAria: "WhatsApp-Nachricht senden",
  },
};
