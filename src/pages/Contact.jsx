            ...
            <div>
              ...
              <Reveal className="flex flex-col gap-3" delay={0.08}>
                <a
                  ...
                  className="group flex items-center justify-between rounded-sm border border-neutral-200 bg-neutral-50 px-5 py-4 shadow-[0_1px_2px_rgba(0,0,0,0.05)] transition-all duration-300 hover:border-neutral-600 hover:bg-neutral-600/5"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-sm bg-neutral-200 group-hover:bg-neutral-600/15 flex items-center justify-center transition-colors duration-300 shrink-0">
                      <EnvelopeIcon size={18} className="text-neutral-600" />
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-neutral-700 tracking-wide group-hover:text-neutral-900 transition-colors duration-200">
                        {t.contact.email}
                      </p>
                  ...
                  <ArrowUpRightIcon
                    size={14}
                    className="text-neutral-400 group-hover:text-neutral-600 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-200"
                  />
                </a>
              ...
              <Reveal
                ...
                delay={0.16}
              >
                <p className="mb-4 text-[0.65rem] leading-4 tracking-[0.1em] uppercase text-neutral-400">
                ...
                <div className="flex flex-col gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 text-xs text-neutral-600 hover:text-neutral-600 transition-colors duration-200 group"
                  >
                    <GithubLogoIcon
                      size={16}
                      className="text-neutral-400 group-hover:text-neutral-600 transition-colors duration-200"
                    />
                    {siteData.github.replace(/^https?:\/\//, "")}
                    <ArrowUpRightIcon
                      size={10}
                      className="text-neutral-300 group-hover:text-neutral-600 transition-colors duration-200"
                    />
                  </a>
                  <a
            ...
            <Reveal delay={0.1}>
              <section className="rounded-sm border border-neutral-200 bg-neutral-50 p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)]">
                <div className="mb-7 pb-7 border-b border-neutral-200">
                  ...
                  <p className="text-[0.65rem] leading-4 tracking-[0.1em] uppercase text-neutral-600">
                    {t.banner.title}
                  </p>
                </div>
